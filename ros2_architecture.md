...
This document outlines the software architecture for the Smart Chess Board project. The system is built on ROS 2 (Humble/Iron) and uses Python (`rclpy`) for all nodes.
